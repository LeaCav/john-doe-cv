...
=======
                        <a href="tel:0620304050" className="">Téléphone : 06 20 30 40 50</a></address>
>>>>>>> home
                        <div className="Logo">
...
=======
                            <li><a class="nav-link active" aria-current="page" href="/">Fresh food</a></li>
                            <li><a class="nav-link active" aria-current="page" href="/">Restaurant Akira</a></li>
                            <li><a class="nav-link active" aria-current="page" href="/">Espace bien-être</a></li>
>>>>>>> home
                        </ul>
                    </div>
                    <div className="col">
